...
./run_kptf_sgd.sh ../data/flixster/rating.train output_ptf_sgd 10 3 10 0.02 1 147612 48794 51 None:1 None:1 None:1 ../data/flixster/rating.test
...
./run_kptf_sgd.sh ../data/flixster/rating.train output_kptf_sgd 10 3 10 0.02 1 147612 48794 51 RL:../data/flixster/network.txt:0.1 None:1 RBF:1 ../data/flixster/rating.test
echo "[DEMO] Finish PTF SGD..."

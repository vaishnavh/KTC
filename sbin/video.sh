...
output=$1"_basic_sgd"
mkdir $output
./run_basic_sgd.sh ../data/video/corrupt_10.csv $output $2 4 $3 $4 $5 240 320 3 141 ../data/video/true_10.csv ../data/video/true_10.csv
...
output=$1"_ptf_sgd"
mkdir $output
./run_kptf_sgd.sh ../data/video/corrupt_10.csv $output $2 4 $3 $4 $5 240 320 3 141 None:1 None:1 None:1 None:1 ../data/video/test.csv
